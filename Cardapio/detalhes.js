        ...
        if (ajax.readyState === 4 && ajax.status === 200) {
            ...
            function addItem() {
                ...
                const dataObj = {
                    ...
                    bebidasSelecionadasH2O:getSelectedOptions("H2O"),
                    bebidasSelecionadascoca:getSelectedOptions("coca"),
                    bebidasSelecionadasagua:getSelectedOptions("agua"),
                    bebidasSelecionadaslata:getSelectedOptions("lata"),
                    bebidasSelecionadaslitro:getSelectedOptions("litro"),
                    bebidasSelecionadasmini:getSelectedOptions("mini")
                ...
                if (isFeijoada) {
                    hasRequiredSelections =
                        dataObj.acompanhamentosfeijoadaSelecionados.length > 0 &&
                        dataObj.guarnicoesfeijoadaSelecionadas.length > 0 &&
                        dataObj.carnesfeijoadaSelecionadas.length > 0;
                } else if (isParmegiana) {
                    hasRequiredSelections =
                        dataObj.acompanhamentosparmegianaSelecionados.length > 0 &&
                        dataObj.guarnicoesparmegianaSelecionadas.length > 0 &&
                        dataObj.carnesparmegianaSelecionadas.length > 0;
                } else if (isBebidas) {
                        dataObj.bebidasSelecionadasH2O.length > 0 &&
                        dataObj.bebidasSelecionadascoca.length > 0 &&
                        dataObj.bebidasSelecionadasagua.length > 0 &&
                        dataObj.bebidasSelecionadaslata.length > 0 &&
                        dataObj.bebidasSelecionadaslitro.length > 0 &&
                        dataObj.bebidasSelecionadasmini.length > 0;
                } else {
                    hasRequiredSelections =
